...
export const scenery_controller = (() => {
  ...
  const multiples = {
    birch1: { name: 'PalmTree_', key: 'birch', num: 5 },
    tree1: { name: 'CommonTree_', key: 'tree', num: 5 },
    rock1: { name: 'BirchTree_', key: 'rock', num: 5 },
    rockMoss1: { name: 'PineTree_', key: 'rockMoss', num: 5 },
    plant1: { name: 'Willow_', key: 'plant', num: 5 },
    ...
    SpawnAt_(biome, spawnPos) {
      ...
      e.AddComponent(
        new render_component.RenderComponent({
          ...
          textures: {
            resourcePath: './resources/wall/Textures/',
